...
public final class StorerServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<org.catmq.protocol.service.GetMessageFromStorerRequest,
      org.catmq.protocol.service.GetMessageFromStorerResponse> getGetMessageFromStorerMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetMessageFromStorer",
      requestType = org.catmq.protocol.service.GetMessageFromStorerRequest.class,
      responseType = org.catmq.protocol.service.GetMessageFromStorerResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<org.catmq.protocol.service.GetMessageFromStorerRequest,
      org.catmq.protocol.service.GetMessageFromStorerResponse> getGetMessageFromStorerMethod() {
    io.grpc.MethodDescriptor<org.catmq.protocol.service.GetMessageFromStorerRequest, org.catmq.protocol.service.GetMessageFromStorerResponse> getGetMessageFromStorerMethod;
    if ((getGetMessageFromStorerMethod = StorerServiceGrpc.getGetMessageFromStorerMethod) == null) {
      synchronized (StorerServiceGrpc.class) {
        if ((getGetMessageFromStorerMethod = StorerServiceGrpc.getGetMessageFromStorerMethod) == null) {
          StorerServiceGrpc.getGetMessageFromStorerMethod = getGetMessageFromStorerMethod =
              io.grpc.MethodDescriptor.<org.catmq.protocol.service.GetMessageFromStorerRequest, org.catmq.protocol.service.GetMessageFromStorerResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetMessageFromStorer"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  org.catmq.protocol.service.GetMessageFromStorerRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  org.catmq.protocol.service.GetMessageFromStorerResponse.getDefaultInstance()))
              .setSchemaDescriptor(new StorerServiceMethodDescriptorSupplier("GetMessageFromStorer"))
              .build();
        }
      }
    }
    return getGetMessageFromStorerMethod;
  }
  ...
  public static abstract class StorerServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void getMessageFromStorer(org.catmq.protocol.service.GetMessageFromStorerRequest request,
        io.grpc.stub.StreamObserver<org.catmq.protocol.service.GetMessageFromStorerResponse> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getGetMessageFromStorerMethod(), responseObserver);
    }
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          ...
          .addMethod(
            getGetMessageFromStorerMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                org.catmq.protocol.service.GetMessageFromStorerRequest,
                org.catmq.protocol.service.GetMessageFromStorerResponse>(
                  this, METHODID_GET_MESSAGE_FROM_STORER)))
          .build();
    }
  }
  ...
  public static final class StorerServiceStub extends io.grpc.stub.AbstractAsyncStub<StorerServiceStub> {
    ...
    public void getMessageFromStorer(org.catmq.protocol.service.GetMessageFromStorerRequest request,
        io.grpc.stub.StreamObserver<org.catmq.protocol.service.GetMessageFromStorerResponse> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getGetMessageFromStorerMethod(), getCallOptions()), request, responseObserver);
    }
  }
  ...
  public static final class StorerServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<StorerServiceBlockingStub> {
    ...
    /**
     */
    public org.catmq.protocol.service.GetMessageFromStorerResponse getMessageFromStorer(org.catmq.protocol.service.GetMessageFromStorerRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
          getChannel(), getGetMessageFromStorerMethod(), getCallOptions(), request);
    }
  }
  ...
  public static final class StorerServiceFutureStub extends io.grpc.stub.AbstractFutureStub<StorerServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<org.catmq.protocol.service.GetMessageFromStorerResponse> getMessageFromStorer(
        org.catmq.protocol.service.GetMessageFromStorerRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
          getChannel().newCall(getGetMessageFromStorerMethod(), getCallOptions()), request);
    }
  }

  private static final int METHODID_SEND_MESSAGE2STORER = 0;
  private static final int METHODID_CREATE_SEGMENT = 1;
  private static final int METHODID_GET_MESSAGE_FROM_STORER = 2;
      ...
      switch (methodId) {
        ...
        case METHODID_CREATE_SEGMENT:
          serviceImpl.createSegment((org.catmq.protocol.service.CreateSegmentRequest) request,
              (io.grpc.stub.StreamObserver<org.catmq.protocol.service.CreateSegmentResponse>) responseObserver);
          break;
        case METHODID_GET_MESSAGE_FROM_STORER:
          serviceImpl.getMessageFromStorer((org.catmq.protocol.service.GetMessageFromStorerRequest) request,
              (io.grpc.stub.StreamObserver<org.catmq.protocol.service.GetMessageFromStorerResponse>) responseObserver);
          break;
        default:
      ...
      synchronized (StorerServiceGrpc.class) {
        ...
        if (result == null) {
          serviceDescriptor = result = io.grpc.ServiceDescriptor.newBuilder(SERVICE_NAME)
              ...
              .addMethod(getGetMessageFromStorerMethod())
              .build();
        }
      }
    }
