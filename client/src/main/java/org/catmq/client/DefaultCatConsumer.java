...
public class DefaultCatConsumer extends ClientConfig {
    ...
    void doSubscribe(TopicDetail topicDetail, ManagedChannel channel) {
        ...
        // Topic订阅采用同步的方式，确保订阅消息被传达到broker，以防止consumer端误判
