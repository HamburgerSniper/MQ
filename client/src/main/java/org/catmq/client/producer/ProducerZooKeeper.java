...
public class ProducerZooKeeper extends BaseZookeeper {
    ...
    protected void increaseTheNumberOfRequestedSessions(String path) {
        try {
            ...
            // broker在zookeeper中的注册信息是由过期时间的，因此必须拿到最新的broker信息
    ...
    private BrokerInfo getBrokerInfo() {
        // TODO：One producer connects with many brokers which has not been considered yet，需要考虑当一个producer与多个broker存在映射关系时的情况
